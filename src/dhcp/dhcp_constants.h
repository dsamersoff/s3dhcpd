#ifndef _DHCP_CONSTANTS_H_
#define _DHCP_CONSTANTS_H_
...
/** DHCP MESSAGE CODES **/
const unsigned char DHCP_DISCOVER = 1;
const unsigned char DHCP_OFFER = 2;
const unsigned char DHCP_REQUEST = 3;
const unsigned char DHCP_DECLINE = 4;
const unsigned char DHCP_ACK = 5;
const unsigned char DHCP_NAK = 6;
const unsigned char DHCP_RELEASE = 7;
const unsigned char DHCP_INFORM = 8;
const unsigned char DHCP_FORCE_RENEW = 9;
const unsigned char DHCP_LEASE_QUERY = 10;
const unsigned char DHCP_LEASE_UNASSIGNED = 11;
const unsigned char DHCP_LEASE_UNKNOWN = 12;
const unsigned char DHCP_LEASE_ACTIVE = 13;
